...
public class StartupUtils {
    ...
    public static void initDefaults() {
        ...
        // Tier 2
        addDefaultSeedOre(makeSeed("Tin", 2, 4, "ingotTin", new ItemStack(getOreStack("ingotTin").getItem(), 8, getOreStack("ingotTin").getItemDamage()), new Color(135, 154, 168)), "ingotTin");
        addDefaultSeedOre(makeSeed("Copper", 2, 4, "ingotCopper", new ItemStack(getOreStack("ingotCopper").getItem(), 8, getOreStack("ingotCopper").getItemDamage()), new Color(204, 102, 51)), "ingotCopper");
        addDefaultSeedOre(makeSeed("Aluminum", 2, 4, "ingotAluminum", new ItemStack(getOreStack("ingotAluminum").getItem(), 8, getOreStack("ingotAluminum").getItemDamage()), new Color(198, 206, 130)), "ingotAluminum");
        addDefaultSeedOre(makeSeed("Zinc", 2, 4, "ingotZinc", new ItemStack(getOreStack("ingotZinc").getItem(), 8, getOreStack("ingotZinc").getItemDamage()), new Color(192, 176, 182)), "ingotZinc");
        addDefaultSeed(makeSeed("Coal", 2, 4, getItemString(Items.coal), new ItemStack(Items.coal, 8), new Color(45, 44, 47)));
        addDefaultSeed(makeSeed("Charcoal", 2, 4, getItemString(Items.coal, 1), new ItemStack(Items.coal, 8, 1), new Color(45, 44, 47)));
        ...
        addDefaultSeed(makeSeed("Leathery", 2, 4, getItemString(Items.leather), new ItemStack(Items.leather, 8), new Color(255, 68, 17)));
        addDefaultSeed(makeSeed("Stringy", 2, 4, getItemString(Items.string), new ItemStack(Items.string, 8), new Color(241, 255, 210)));
        addDefaultSeed(makeSeed("Boney", 2, 4, getItemString(Items.bone), new ItemStack(Items.bone, 8), new Color(255, 240, 205)));
        addDefaultSeed(makeSeed("Slimey", 2, 4, getItemString(Items.slime_ball), new ItemStack(Items.slime_ball, 8), new Color(62, 255, 119)));
        //Tier 3
        addDefaultSeed(makeSeed("Blaze", 3, 4, getItemString(Items.blaze_rod), new ItemStack(Items.blaze_rod, 8), new Color(255, 215, 66)));
        addDefaultSeedOre(makeSeed("Iron", 3, 4, "ingotIron", new ItemStack(getOreStack("ingotIron").getItem(), 8, getOreStack("ingotIron").getItemDamage()), new Color(159, 156, 160)), "ingotIron");
        addDefaultSeedOre(makeSeed("Gold", 3, 4, "ingotGold", new ItemStack(getOreStack("ingotGold").getItem(), 8, getOreStack("ingotGold").getItemDamage()), new Color(255, 255, 0)), "ingotGold");
        addDefaultSeedOre(makeSeed("Lead", 3, 4, "ingotLead", new ItemStack(getOreStack("ingotLead").getItem(), 8, getOreStack("ingotLead").getItemDamage()), new Color(102, 102, 153)), "ingotLead");
        addDefaultSeedOre(makeSeed("Silver", 3, 4, "ingotSilver", new ItemStack(getOreStack("ingotSilver").getItem(), 8, getOreStack("ingotSilver").getItemDamage()), new Color(187, 189, 184)), "ingotSilver");
        addDefaultSeedOre(makeSeed("Nickel", 3, 4, "ingotNickel", new ItemStack(getOreStack("ingotNickel").getItem(), 8, getOreStack("ingotNickel").getItemDamage()), new Color(204, 204, 204)), "ingotNickel");
        addDefaultSeedOre(makeSeed("Mithril", 3, 4, "ingotMithril", new ItemStack(getOreStack("ingotMithril").getItem(), 8, getOreStack("ingotMithril").getItemDamage()), new Color(146, 164, 208)), "ingotMithril");
        addDefaultSeedOre(makeSeed("Osmium", 3, 4, "ingotOsmium", new ItemStack(getOreStack("ingotOsmium").getItem(), 8, getOreStack("ingotOsmium").getItemDamage()), new Color(68, 60, 190)), "ingotOsmium");
        ...
        addDefaultSeedOre(makeSeed("Quartz", 3, 4, "gemQuartz", new ItemStack(getOreStack("gemQuartz").getItem(), 8, getOreStack("gemQuartz").getItemDamage()), new Color(255, 255, 255)), "gemQuartz");
        addDefaultSeedOre(makeSeed("Certus", 3, 4, "crystalCertusQuartz", new ItemStack(getOreStack("crystalCertusQuartz").getItem(), 8, getOreStack("crystalCertusQuartz").getItemDamage()), new Color(168, 204, 208)), "crystalCertusQuartz");
