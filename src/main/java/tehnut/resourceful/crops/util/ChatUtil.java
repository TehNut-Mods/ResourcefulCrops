...
import tehnut.resourceful.crops.network.ResourcefulPacketHandler;
import tehnut.resourceful.crops.util.helper.TextHelper;
...
public class ChatUtil {
    ...
    public static void sendNoSpam(EntityPlayerMP player, IChatComponent... lines) {
        if (lines.length > 0)
            ResourcefulPacketHandler.INSTANCE.sendTo(new PacketNoSpamChat(lines), player);
    }
}
