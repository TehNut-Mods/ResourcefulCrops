...
public class SeedLoader {
    ...
    private static Set<Seed> getDefaults() {
        ...
        // Tier 1
        addSeed(defaultSeeds, "inky", 0, "dyeBlack", 8);
        ...
        // Tier 2
        addSeed(defaultSeeds, "tin", 1, "ingotTin", 4);
        addSeed(defaultSeeds, "copper", 1, "ingotCopper", 4);
        addSeed(defaultSeeds, "aluminum", 1, "ingotAluminum", 4);
        addSeed(defaultSeeds, "zinc", 1, "ingotZinc", 4);
        ...
        addSeed(defaultSeeds, "saltpeter", 1, "dustSaltpeter", 8);
        addSeed(defaultSeeds, "salty", 1, "dustSalt", 8);
        ...
        addSeed(defaultSeeds, "ferrous", 2, "ingotIron", 4);
        addSeed(defaultSeeds, "golden", 2, "ingotGold", 4);
        addSeed(defaultSeeds, "lead", 2, "ingotLead", 4);
        addSeed(defaultSeeds, "silver", 2, "ingotSilver", 4);
        addSeed(defaultSeeds, "nickel", 2, "ingotNickel", 4);
        addSeed(defaultSeeds, "mithril", 2, "ingotMithril", 4);
        addSeed(defaultSeeds, "osmium", 2, "ingotOsmium", 4);
        ...
        addSeed(defaultSeeds, "glowing", 2, "dustGlowstone", 8);
        addSeed(defaultSeeds, "redstone", 2, "dustRedstone", 8);
        addSeed(defaultSeeds, "sulfur", 2, "dustSulfur", 8);
        addSeed(defaultSeeds, "lapis", 2, "gemLapis", 8);
        addSeed(defaultSeeds, "quartz", 2, "gemQuartz", 4);
        addSeed(defaultSeeds, "certus", 2, "crystalCertusQuartz", 4);
        addSeed(defaultSeeds, "ruby", 2, "gemRuby", 8);
        addSeed(defaultSeeds, "peridot", 2, "gemPeridot", 8);
        addSeed(defaultSeeds, "topaz", 2, "gemTopaz", 8);
        addSeed(defaultSeeds, "tanzanite", 2, "gemTanzanite", 8);
        addSeed(defaultSeeds, "malachite", 2, "gemMalachite", 8);
        addSeed(defaultSeeds, "sapphire", 2, "gemSapphire", 8);
        addSeed(defaultSeeds, "amber", 2, "gemAmber", 8);
        addSeed(defaultSeeds, "apatite", 2, "gemApatite", 8);
        // Tier 4
        addSeed(defaultSeeds, "witherwheat", 3, 2, new Color(52, 52, 51), new ItemStack(Items.SKULL, 1, 1), 1);
        addSeed(defaultSeeds, "diamond", 3, "gemDiamond", 1);
        addSeed(defaultSeeds, "emerald", 3, "gemEmerald", 1);
        addSeed(defaultSeeds, "platinum", 3, "ingotPlatinum", 1);
        addSeed(defaultSeeds, "yellorium", 3, "ingotYellorium", 2);
        addSeed(defaultSeeds, "titanium", 3, "ingotTitanium", 1);
        addSeed(defaultSeeds, "desh", 3, "ingotDesh", 1);
        addSeed(defaultSeeds, "cobalt", 3, "ingotCobalt", 1);
        addSeed(defaultSeeds, "ardite", 3, "ingotArdite", 1);
    ...
    private static void addSeed(Set<Seed> seeds, String name, int tier, int amount, Color color, ItemStack stack, int outputAmount) {
        ...
        seeds.add(new Seed(name, tier, amount, false, color, stack, new Output(output, Output.Shape.DEFAULT, null), null, null));
    }

    private static void addSeed(Set<Seed> seeds, String name, int tier, String oreDict, int outputAmount) {
        if (OreDictionary.doesOreNameExist(oreDict) && OreDictionary.getOres(oreDict).size() > 0) {
            ...
            output.setCount(outputAmount);
            Seed seed = new Seed(name, tier, 4, false, null, oreDict, new Output(output, Output.Shape.DEFAULT, null), null, null);
